...
function ProblemForm({ mode, onSubmit, initialData }) {
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="card bg-base-100 border border-base-300 shadow-xl">
                        <div className="card-body">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-4">
                                    <div className="form-control w-1/2 flex gap-2">
                                        <label className="label">
                        ...
                        {/* Test Cases */}
                        <div className="card bg-base-00 shadow-lg p-6">
                            <h2 className="text-2xl font-bold flex items-center gap-2">
                                Test Cases
                            </h2>
                            ...
                            <div className="space-y-4 mt-4 mb-6">
                                <div className="flex justify-between px-6 py-4 border rounded-lg">
                                    <h3 className="font-bold text-lg flex items-center gap-2">
                                        <Eye className="w-6 h-6 text-success" />
                                        Visible Test Cases</h3>
                                    <button
                                        type="button"
                        ...
                        <div>
                            <button
                                type="submit"
                                className="btn btn-primary btn-lg w-full border-0 rounded-lg shadow-2xl"
                            >
